...
import { Users, FileText, BookOpen, Building, Building2, Calendar, RefreshCw, Download, Upload, Layers, ArrowLeftRight, Contact } from 'lucide-react'
...
const adminNav = [
  ...
  { to: '/admin/staff',        label: 'Personal',        icon: Contact },
